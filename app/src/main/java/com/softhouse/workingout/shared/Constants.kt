...
object Constants {
    ...
    const val REPETITIVE_FLAG = "REPETITIVE_FLAG"
    const val INTERVAL_FLAG = "INTERVAL_FLAG"
    const val START_SERVICE_FLAG = "START_SERVICE_FLAG"
    const val SCHEDULE_ID_FLAG = "SCHEDULE_ID_FLAG"
