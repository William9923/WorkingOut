...
@AndroidEntryPoint
class TwoPaneCyclingLogsFragment : Fragment(), CyclingLogsRecyclerViewAdapter.OnCyclingRecordClickListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentTwoPaneCyclingLogsBinding.inflate(inflater, container, false)
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        if (requireActivity().resources?.configuration?.orientation == Configuration.ORIENTATION_PORTRAIT) {
            val action = TwoPaneCyclingLogsFragmentDirections.actionNavigationTwoPaneCyclingLogsToNavigationLogsCycling()
